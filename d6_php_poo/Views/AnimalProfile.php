        ...
        <div class="col-16 card shadow mx-auto mt-3">
            <div class="card-header text-center bg-light text-light mt-2 header-img ">
                <header class="header-txt">
                    <h3>Information de <?= $animal["nomAnimal"] ?></h3>
                </header>
            </div>
            <div class="my-2">
                ...
                <table class="table">
                    <thead class="table-dark zoo">
                        ...
                        <tr>
                            ...
                            <td><a href="index.php?p=animal/update&id=<?= $animal["idAnimal"] ?>" id="" class="btn btn-primary">Editer</a>
                                <a onclick="return confirm('Es-tu sûre de vouloir me supprimer ?')" href="index.php?p=animal/delete/id/<?= $animal["idAnimal"] ?>" id="" class="btn btn-danger">X</a>                                
                            </td>
                        </tr>
                </table>
            </div>
